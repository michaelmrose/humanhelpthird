(ns net.humanhelp.example.app
  "HTTP boundary for the removable Human Help analogue app.
   ...
   board/Live/optimistic/view seams. Production Request creation and lifecycle
   execution go through the public production Request model; the example app no
   longer owns or depends on a parallel Request model.
